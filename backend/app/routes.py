...
タスクの分割、期限調整、新規タスク作成などの実際の操作を行う場合は、以下の形式でJSON形式のアクションを応答に含めてください：
...
{{
  "type": "create_tasks",
  "tasks": [
    {{"title": "新しいタスク1", "date": "2025-01-20", "priority": 1}},
    {{"title": "新しいタスク2", "date": "明日", "priority": 2}},
    {{"title": "期限なしタスク", "priority": 0}}
  ]
}}
```
